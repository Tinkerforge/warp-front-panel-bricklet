...
#define ST7789_SELECT_PIN           P3_0
#define ST7789_SELECT_PIN_AF        (XMC_GPIO_MODE_OUTPUT_PUSH_PULL_ALT7 | P3_0_AF_U1C0_SELO1)
...
#define ST7789_SLAVE                XMC_SPI_CH_SLAVE_SELECT_1

#define ST7789_RX_FIFO_DATA_POINTER 0
#define ST7789_TX_FIFO_DATA_POINTER 32
#define ST7789_RX_FIFO_SIZE         XMC_USIC_CH_FIFO_SIZE_32WORDS
#define ST7789_TX_FIFO_SIZE         XMC_USIC_CH_FIFO_SIZE_32WORDS
